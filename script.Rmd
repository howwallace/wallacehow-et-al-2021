...
```{r}
hsas_metrics <- metrics_merged[,c('HSA','DCI.Change','Med.Enrollees_2003','Med.Enrollees_2015')]
colnames(hsas_metrics) <- c('HSA', 'DCI.Change', 'Enrollees.2000', 'Enrollees.2015')
...
town_names <- economic_descriptors_2000 %>%
  ...
  select(City, State, DCI.Change, Enrollees.2000, Enrollees.2015)

high_to_low <- town_names[town_names$DCI.Change == "Highest > Low",]
high_to_low <- high_to_low %>% select(City, State, Enrollees.2000, Enrollees.2015)
...
low_to_high <- low_to_high %>% select(City, State, Enrollees.2000, Enrollees.2015)
...
high_to_low <- high_to_low %>%
  mutate(Pop.Ratio = Enrollees.2015 / Enrollees.2000)
