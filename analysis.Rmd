...
setwd("/Users/harperwallace/Dropbox/GitHub/howw-dci-quality-measures-2021/")
...
Number of HSAs in each `DCI.Change` group:
```{r}
metrics_merged %>%
  group_by(DCI.Change) %>%
  summarise(n = n(),
...
Read pc_metrics distinguishing 2003--2005 from 2006--2007
```{r}
...
Read pc_metrics combining 2003--2007
```{r}
